...
export const APP_STRING_KEYS = {
    ...
    EARN_USDT: 'APP.AFFILIATES.EARN_USDT',
    EARN_USDT_DISCRIPTION: 'APP.AFFILIATES.EARN_USDT_DISCRIPTION',
    ...
    APPROVE_USDT: 'APP.DEPOSIT_MODAL.APPROVE_USDT',
    ...
    DEPOSIT_USDT_INFO: 'APP.DEPOSIT_OPTIONS.DEPOSIT_USDT_INFO',
    ...
    AMOUNT_FILLED: 'APP.SPOT.AMOUNT_FILLED',
    AMOUNT_MUST_BE_GREATER_THAN_ZERO: 'APP.SPOT.AMOUNT_MUST_BE_GREATER_THAN_ZERO',
    AVAILABLE_TO_TRADE: 'APP.SPOT.AVAILABLE_TO_TRADE',
    CANNOT_PLACE_MARKET_ORDER: 'APP.SPOT.CANNOT_PLACE_MARKET_ORDER',
    CANNOT_PLACE_MARKET_ORDER_NO_PRICE: 'APP.SPOT.CANNOT_PLACE_MARKET_ORDER_NO_PRICE',
    CHANGE_24H: 'APP.SPOT.CHANGE_24H',
    ERROR_SUBMITTING: 'APP.SPOT.ERROR_SUBMITTING',
    EXPECTED_PRICE: 'APP.SPOT.EXPECTED_PRICE',
    FAILED_TO_PLACE_ORDER: 'APP.SPOT.FAILED_TO_PLACE_ORDER',
    FEE: 'APP.SPOT.FEE',
    FILLS_EMPTY_STATE: 'APP.SPOT.FILLS_EMPTY_STATE',
    FILLS_LABEL: 'APP.SPOT.FILLS_LABEL',
    GOOD_TIL: 'APP.SPOT.GOOD_TIL',
    GOOD_TIL_TIME: 'APP.SPOT.GOOD_TIL_TIME',
    IMMEDIATE_OR_CANCEL: 'APP.SPOT.IMMEDIATE_OR_CANCEL',
    INSUFFICIENT_ASSET_BALANCE: 'APP.SPOT.INSUFFICIENT_ASSET_BALANCE',
    INSUFFICIENT_ASSET_BALANCE_DETAILED: 'APP.SPOT.INSUFFICIENT_ASSET_BALANCE_DETAILED',
    INVALID_CLOB_PAIR_ID: 'APP.SPOT.INVALID_CLOB_PAIR_ID',
    INVALID_MARKET_INFO: 'APP.SPOT.INVALID_MARKET_INFO',
    KYC_REQUIRED_BODY: 'APP.SPOT.KYC_REQUIRED_BODY',
    KYC_REQUIRED_TITLE: 'APP.SPOT.KYC_REQUIRED_TITLE',
    KYC_VERIFY_ACTION: 'APP.SPOT.KYC_VERIFY_ACTION',
    KYC_VERIFY_REVIEW: 'APP.SPOT.KYC_VERIFY_REVIEW',
    LIMIT_ORDER_SHORT: 'APP.SPOT.LIMIT_ORDER_SHORT',
    LIMIT_PRICE: 'APP.SPOT.LIMIT_PRICE',
    LIQUIDITY: 'APP.SPOT.LIQUIDITY',
    MARKET_CAP_BILLION: 'APP.SPOT.MARKET_CAP_BILLION',
    MARKET_CAP_TRILLION: 'APP.SPOT.MARKET_CAP_TRILLION',
    MARKET_ORDER_SHORT: 'APP.SPOT.MARKET_ORDER_SHORT',
    MARKET_PRICE_INVALID: 'APP.SPOT.MARKET_PRICE_INVALID',
    MARKET_PRICE_SHORT: 'APP.SPOT.MARKET_PRICE_SHORT',
    MAX_100_PERCENT: 'APP.SPOT.MAX_100_PERCENT',
    MID_MARKET_PRICE_SHORT: 'APP.SPOT.MID_MARKET_PRICE_SHORT',
    MISSING_REQUIRED_DATA: 'APP.SPOT.MISSING_REQUIRED_DATA',
    MUST_BE_GREATER_THAN_ZERO: 'APP.SPOT.MUST_BE_GREATER_THAN_ZERO',
    NO_BALANCE_DATA_AVAILABLE: 'APP.SPOT.NO_BALANCE_DATA_AVAILABLE',
    OPEN_ORDERS_HEADER: 'APP.SPOT.OPEN_ORDERS_HEADER',
    ORACLE_PRICE: 'APP.SPOT.ORACLE_PRICE',
    ORDERBOOK: 'APP.SPOT.ORDERBOOK',
    ORDERS_EMPTY_STATE: 'APP.SPOT.ORDERS_EMPTY_STATE',
    ORDER_CROSSES_OWN_ORDER: 'APP.SPOT.ORDER_CROSSES_OWN_ORDER',
    ORDER_HISTORY_HEADER: 'APP.SPOT.ORDER_HISTORY_HEADER',
    PLACE_ORDER: 'APP.SPOT.PLACE_ORDER',
    POSITIONS: 'APP.SPOT.POSITIONS',
    POSITIONS_EMPTY_STATE: 'APP.SPOT.POSITIONS_EMPTY_STATE',
    PRICE_AFTER_ALIGNMENT_TOO_SMALL: 'APP.SPOT.PRICE_AFTER_ALIGNMENT_TOO_SMALL',
    PRICE_IMPACT: 'APP.SPOT.PRICE_IMPACT',
    PRICE_MUST_BE_GREATER_THAN_ZERO: 'APP.SPOT.PRICE_MUST_BE_GREATER_THAN_ZERO',
    SIZE_AFTER_ALIGNMENT_TOO_SMALL: 'APP.SPOT.SIZE_AFTER_ALIGNMENT_TOO_SMALL',
    SLASH_SEPARATOR: 'APP.SPOT.SLASH_SEPARATOR',
    SPOT_MARKET_NOT_FOUND: 'APP.SPOT.SPOT_MARKET_NOT_FOUND',
    SPOT_POSITIONS: 'APP.SPOT.SPOT_POSITIONS',
    SPOT_POSITIONS_DESCRIPTION: 'APP.SPOT.SPOT_POSITIONS_DESCRIPTION',
    SUBMITTING_ORDER: 'APP.SPOT.SUBMITTING_ORDER',
    TIME_IN_FORCE: 'APP.SPOT.TIME_IN_FORCE',
    TOTAL: 'APP.SPOT.TOTAL',
    TOTAL_ASSETS: 'APP.SPOT.TOTAL_ASSETS',
    TRADES_24H: 'APP.SPOT.TRADES_24H',
    TRADE_CONFIRMED: 'APP.SPOT.TRADE_CONFIRMED',
    VOLUME_24H: 'APP.SPOT.VOLUME_24H',
    WHEN_PRICE_REACHES: 'APP.SPOT.WHEN_PRICE_REACHES',
    ...
    CLAIM_USDT_AMOUNT: 'APP.STAKING_REWARDS.CLAIM_USDT_AMOUNT',
    ...
    ACCEPTED_ASSETS_AND_USDT: 'APP.TURNKEY_ONBOARD.ACCEPTED_ASSETS_AND_USDT',
    ACCEPTS_ONLY_USDT: 'APP.TURNKEY_ONBOARD.ACCEPTS_ONLY_USDT',
    ...
    LOWEST_FEES_WITH_USDT: 'APP.WITHDRAW_MODAL.LOWEST_FEES_WITH_USDT',
...
export const ERRORS_STRING_KEYS = {
    ...
    LAUNCHING_MARKET_REQUIRES_USDT: 'ERRORS.NEW_MARKET_WIDGET.LAUNCHING_MARKET_REQUIRES_USDT',
